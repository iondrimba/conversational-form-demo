...
TagManager.prototype = {
  ...
  bindEvents: function ($) {
    $("[data-gtm-event='ga-event']").off("click.ga-event").on("click.ga-event", this.clickGAEvent.bind(this));
  },
...
(function () { var t, e, n, o, r, i = [].slice; n = function (t) { var e, n; return e = document.createElement("div"), e.innerHTML = '<a href="' + t + '">x</a>', n = e.firstChild, "" + n.host }, o = function (t, e, n) { var o, r, i; return null == e && (e = {}), e.i = (new Date).getTime(), e = function () { var t; t = []; for (r in e) i = e[r], t.push(r + "=" + encodeURIComponent(i)); return t }().join("&"), o = new Image, n && (o.onload = n), o.src = t + "?" + e, !0 }, r = function (t, e, n) { var o, r; return null == n && (n = {}), n.expires === !0 && (n.expires = -1), "number" == typeof n.expires && (r = new Date, r.setTime(r.getTime() + 24 * n.expires * 60 * 60 * 1e3), n.expires = r), e = (e + "").replace(/[^!#-+\--:<-\[\]-~]/g, encodeURIComponent), o = encodeURIComponent(t) + "=" + e, n.expires && (o += ";expires=" + n.expires.toGMTString()), n.path && (o += ";path=" + n.path), n.domain && (o += ";domain=" + n.domain), document.cookie = o }, e = function (t) { var e, n, o, r, i, s, a; for (n = document.cookie.split("; "), o = 0, s = n.length; s > o; o++) if (e = n[o], r = e.indexOf("="), i = decodeURIComponent(e.substr(0, r)), a = decodeURIComponent(e.substr(r + 1)), i === t) return a; return null }, t = function () { var t, e, n, o, r, s, a; for (s = arguments[0], t = 2 <= arguments.length ? i.call(arguments, 1) : [], e = 0, o = t.length; o > e; e++) { r = t[e]; for (n in r) a = r[n], null != a && (s[n] = a) } return s }, this.Abba = function () { function n(t, e) { if (null == e && (e = {}), !t) throw new Error("Experiment name required"); return this instanceof n ? (this.name = t, this.options = e, this.variants = [], void (this.endpoint = this.options.endpoint || this.constructor.endpoint)) : new n(t, e) } return n.prototype.endpoint = "http://localhost:4567", n.prototype.defaults = { path: "/", expires: 600 }, n.prototype.variant = function (t, e, n) { if ("string" != typeof t) throw new Error("Variant name required"); return "object" != typeof e && (n = e, e = {}), e.name = t, e.callback = n, null == e.weight && (e.weight = 1), this.variants.push(e), this }, n.prototype.control = function (t, e, n) { return null == t && (t = "Control"), "object" != typeof e && (n = e, e = {}), e.control = !0, this.variant(t, e, n) }, n.prototype["continue"] = function () { var t; return (t = this.getPreviousVariant()) && this.useVariant(t), this }, n.prototype.start = function (t, e) { var n, o, r, i, s, a, p, u, h, c, l; if (null == e && (e = {}), c = this.getPreviousVariant()) return this.useVariant(c), this; if (null != t) c = this.getVariantForName(t), c || (c = { name: t, control: e.control }); else { for (u = 0, a = this.variants, n = 0, r = a.length; r > n; n++) h = a[n], u += h.weight; for (s = Math.random() * u, l = 0, p = this.variants, o = 0, i = p.length; i > o && (c = p[o], l += c.weight, !(l >= s)); o++); } if (!c) throw new Error("No variants added"); return this.recordStart(c), this.useVariant(c), this }, n.prototype.complete = function (t) { return t || (t = this.getVariantCookie()), t ? this.hasPersistCompleteCookie() ? this : (this.options.persist ? this.setPersistCompleteCookie() : this.reset(), this.recordComplete(t), this) : this }, n.prototype.reset = function () { return this.removeVariantCookie(), this.removePersistCompleteCookie(), this.result = null, this }, n.prototype.getVariantForName = function (t) { var e; return function () { var n, o, r, i; for (r = this.variants, i = [], n = 0, o = r.length; o > n; n++) e = r[n], e.name === t && i.push(e); return i }.call(this)[0] }, n.prototype.useVariant = function (t) { return null != t && "function" == typeof t.callback && t.callback(), this.chosen = t }, n.prototype.recordStart = function (t) { return this.setVariantCookie(t.name) }, n.prototype.recordComplete = function (t) { return o(this.endpoint + "/complete", { experiment: this.name, variant: t }) }, n.prototype.getPreviousVariant = function () { var t; return (t = this.getVariantCookie()) ? this.getVariantForName(t) : void 0 }, n.prototype.getVariantCookie = function () { return this.getCookie("abbaVariant_" + this.name) }, n.prototype.setVariantCookie = function (t) { return this.setCookie("abbaVariant_" + this.name, t, { expires: this.options.expires }) }, n.prototype.removeVariantCookie = function () { return this.setCookie("abbaVariant_" + this.name, "", { expires: !0 }) }, n.prototype.setPersistCompleteCookie = function () { return this.setCookie("abbaPersistComplete_" + this.name, "1", { expires: this.options.expires }) }, n.prototype.hasPersistCompleteCookie = function () { return !!this.getCookie("abbaPersistComplete_" + this.name) }, n.prototype.removePersistCompleteCookie = function () { return this.setCookie("abbaPersistComplete_" + this.name, "", { expires: !0 }) }, n.prototype.setCookie = function (e, n, o) { return null == o && (o = {}), r(e, n, t({}, this.defaults, o)) }, n.prototype.getCookie = function (n, o) { return null == o && (o = {}), e(n, t({}, this.defaults, o)) }, n }(), function () { var t, e; return e = document.getElementsByTagName("script"), e = function () { var n, o, r; for (r = [], n = 0, o = e.length; o > n; n++) t = e[n], /\/abba\.js$/.test(t.src) && r.push(t.src); return r }(), e[0] ? Abba.endpoint = "//" + n(e[0]) : void 0 }() }).call(this);
...
(function (f) { if (typeof exports === "object" && typeof module !== "undefined") { module.exports = f() } else if (typeof define === "function" && define.amd) { define([], f) } else { var g; if (typeof window !== "undefined") { g = window } else if (typeof global !== "undefined") { g = global } else if (typeof self !== "undefined") { g = self } else { g = this } (g.airbrakeJs || (g.airbrakeJs = {})).Client = f() } })(function () {
  var define, module, exports; return (function e(t, n, r) { function s(o, u) { if (!n[o]) { if (!t[o]) { var a = typeof require == "function" && require; if (!u && a) return a(o, !0); if (i) return i(o, !0); var f = new Error("Cannot find module '" + o + "'"); throw f.code = "MODULE_NOT_FOUND", f } var l = n[o] = { exports: {} }; t[o][0].call(l.exports, function (e) { var n = t[o][1][e]; return s(n ? n : e) }, l, l.exports, e, t, n, r) } return n[o].exports } var i = typeof require == "function" && require; for (var o = 0; o < r.length; o++)s(r[o]); return s })({
    ...
    }, { "../internal/jsonify_notice": 4 }]
  }, {}, [1])(1)
});
(function (f) { if (typeof exports === "object" && typeof module !== "undefined") { module.exports = f() } else if (typeof define === "function" && define.amd) { define([], f) } else { var g; if (typeof window !== "undefined") { g = window } else if (typeof global !== "undefined") { g = global } else if (typeof self !== "undefined") { g = self } else { g = this } g = (g.airbrakeJs || (g.airbrakeJs = {})); g = (g.instrumentation || (g.instrumentation = {})); g.jquery = f() } })(function () {
  var define, module, exports; return (function e(t, n, r) { function s(o, u) { if (!n[o]) { if (!t[o]) { var a = typeof require == "function" && require; if (!u && a) return a(o, !0); if (i) return i(o, !0); var f = new Error("Cannot find module '" + o + "'"); throw f.code = "MODULE_NOT_FOUND", f } var l = n[o] = { exports: {} }; t[o][0].call(l.exports, function (e) { var n = t[o][1][e]; return s(n ? n : e) }, l, l.exports, e, t, n, r) } return n[o].exports } var i = typeof require == "function" && require; for (var o = 0; o < r.length; o++)s(r[o]); return s })({
    1: [function (require, module, exports) {
      (function (global) {
...
modulejs.define("Airbrake", function () {
  "use strict";
  ...
  Module.prototype = {
    ...
    filter: function () {
      this.airbrake.addFilter(this.onFilter.bind(this));
    },

    init: function () {
      this.airbrake = new airbrakeJs.Client(this.options);
    },

    instrument: function () {
      if (jQuery) {
        airbrakeJs.instrumentation.jquery(this.airbrake, jQuery);
      }
    },

    onFilter: function (notice) {
      if (this.environment !== "production") {
        console.log("[onFilter] ignored:", notice);

        return null;
      }

      console.log("[onFilter] reporting:", notice);

      return notice;
    },

    onReporter: function (notice) {
      console.log(notice);
    },

    reporter: function () {
      if (console && console.log) {
        this.airbrake.addReporter(this.onReporter);
      }
    }
  };
...
var Airbrake = modulejs.require("Airbrake");

new Airbrake({
  environment: "production",
  projectId: 0,
  projectKey: "api_key.example"
}).create();
var SCO = window.SCO || {}
...
SCO.Flash = SCO.Flash || function (flashesElement) {
  var showMessages = function (flashMessagesElement) {
    $(flashMessagesElement).parent().show(0, function () {
      $(this).addClass("animate")
    })
    $(flashMessagesElement).parent().delay(3500).fadeOut()
  }
  ...
  var flash = {
    ...
    show: function (name, message) {
      var whiteListedFlashes = ["message", "messages", "notice", "error", "success", "email_confirmation_pending"];

      if (_.contains(whiteListedFlashes, name)) {
        $(flashesElement).parent().addClass(name);
        $(flashesElement).html(message);
        showMessages(flashesElement);
      }
    },

    watchForRequests: function () {
      var pool = []
      var _xhr = $.ajaxSettings.xhr

      var restoreJQueryXHRFactory = function () {
        $.ajaxSettings.xhr = _xhr
      }

      var releaseInternalXHRPool = function () {
        $.each(pool, function (i, xhr) {
          xhr["_send"]()
        })
      }

      // intercepts just getninjas.com.br and NON /flash requests
      var needInterceptXHR = function (url) {
        //http://rubular.com/r/uRJV1VkUkp
        var getninjasHostRegexp = /(http(s*):\/\/)(.*)(getninjas)/
        var isInternalRequest = url.startsWith("/") || getninjasHostRegexp.test(url)
        var isNotFlashRequest = !url.startsWith("/flash")
        return isInternalRequest && isNotFlashRequest
      }

      var proxifyXHRCall = function (xhr) {
        xhr["_send"] = xhr.send
        xhr.send = function () { }
        pool.push(xhr)
      }

      var openReplacementToEnqueueGetninjasRequests = function () {
        var url = arguments[1]
        if (needInterceptXHR(url)) {
          proxifyXHRCall(this)
        }
        this["_open"].apply(this, arguments)
      }

      var delayedXHRFactory = function () {
        var xhr = _xhr()
        xhr["_open"] = xhr.open
        xhr.open = openReplacementToEnqueueGetninjasRequests
        return xhr
      }
      $.ajaxSettings.xhr = delayedXHRFactory

      flash.loadFlashesInto(flashesElement, function () {
        restoreJQueryXHRFactory()
        releaseInternalXHRPool()
      })

      return this
    },

    loadFlashesInto: function (flashMessages, onComplete) {
      var onComplete = onComplete || function () { }

      var extractMessages = function (flashes) {
        var messages = []
        for (type in flashes) {
          var isFlashMessage = flashes.hasOwnProperty(type)
          if (isFlashMessage) {
            messages.push(flashes[type])
          }
        }
        return messages;
      }

      var writeTo = function (element, messages) {
        var fullMessage = ""
        ...
        $(element).html(fullMessage)
      }

      var showFlashMessages = function (flashes) {
        var messages = extractMessages(flashes)
        if (messages.length > 0) {
          writeTo($(flashMessages), messages)
          showMessages(flashMessages)
        }
        onComplete(flashes);
      }

      $.get("/flash", showFlashMessages)
    }
  }

  // initialization
  $(function () {
    // usar uma referência a variável flash aqui dentro,
    // tende a dar memory leak? ass.: Valeriano Burrão
    $(".flash .close").click(flash.close)
  })
